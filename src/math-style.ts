...
.pi-math { color: inherit; }
.pi-math[data-pi-math-display="false"] {
...
.pi-math .katex-display {
  margin: .5em 0; width: max-content; min-width: 100%;
}
.pi-math[data-pi-math-state="error"],
.pi-math[data-pi-math-state="limited"] {
  white-space: pre-wrap; overflow-wrap: anywhere;
}
.pi-math-shell {
  position: relative; max-width: 100%; vertical-align: baseline;
}
.pi-math-shell[data-pi-math-display="false"] {
  display: inline;
}
.pi-math-shell[data-pi-math-display="true"] {
  display: block; width: 100%;
}
.pi-math-controls { display: inline; }
.pi-math-source-button {
...
.pi-math-shell:is(:hover, :focus-within) .pi-math-source-button,
.pi-math-source-button:focus-visible {
  opacity: 1;
}
...
.pi-math-source-popover[hidden] { display: none; }
.pi-math-source-popover code {
  overflow-wrap: anywhere; white-space: pre-wrap;
}
.pi-math-source-popover button {
...
.pi-math-action-status {
  min-height: 1.25rem; color: var(--accent); font-size: 11px;
  overflow-wrap: anywhere;
}
.pi-math-shell[data-pi-math-overflow-right="true"]::after {
...
.pi-math-overflow-hint[hidden] { display: none; }
